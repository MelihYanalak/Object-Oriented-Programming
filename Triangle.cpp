...
namespace Melih{
	...
	Triangle& Triangle::operator++(int ignoreMe){
		...
		temp5 = getRightX();
		temp6 = getRightY();
		Triangle* newTri = new Triangle(getSide(),temp1,temp2,temp3,temp4,temp5,temp6);
		setLeftX(getLeftX()+1.0);
		setLeftY(getLeftY()+1.0);
		setMidX(getMidX()+1.0);
		setMidY(getMidY()+1.0);
	...
	Triangle& Triangle::operator+(double num)const{
		Triangle* newTri = new Triangle(getSide()+num,getLeftX(),getLeftY(),getMidX(),getMidY(),getRightX(),getRightY());
		return *newTri;
	}
	Triangle& Triangle::operator-(double num)const{
		Triangle* newTri = new Triangle(getSide()-num,getLeftX(),getLeftY(),getMidX(),getMidY(),getRightX(),getRightY());
